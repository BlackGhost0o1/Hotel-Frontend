        ...
        <div className="flex flex-col md:pb-16 lg:pb-0 relative">
          ...
          <article className="slide-testimonial md:w-[30rem] lg:w-[25rem] sm:w-[20rem] opacity-0 absolute top-14 drop-shadow-md slide-testimonial-active">
            <p className="text-base">
              “I had the most amazing experience booking my vacation through Wanderlust Travel Agency! From the moment I contacted them, their team was incredibly helpful and attentive to my needs.  ”
            </p>
            <p className="pt-5">
              <div className="font-bold text-sm">PHLEO-DELLY</div>
              <p className="text-xs">Kasoa, Ghana</p>
            </p>
          </article>
          <article className="slide-testimonial md:w-[30rem] lg:w-[25rem] sm:w-[20rem] opacity-0 drop-shadow-md">
            <p className="text-base">
              “Booking our honeymoon through GlobeTrotters Travel Agency was the best decision we made! Their team took the time to understand our preferences and budget, and they curated a dream vacation for us. ”
            </p>
            <p className="pt-5">
              <div className="font-bold text-sm">TRAVIS</div>
              <p className="text-xs">Dansoman Estate</p>
            </p>
          </article>
        </div>
      </section>
